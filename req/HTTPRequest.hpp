...
struct BodyPart
{
    int is_file; // 1 if the part is a file, 0 if it is text
    std::string data;  // data of the part : can be text or binary
    std::string name; // name of the part
    std::string filename; // filename of the part
    std::string type_of_file; // type of the file
